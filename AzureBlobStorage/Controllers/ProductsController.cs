...
namespace AzureBlobStorage.Controllers
{
    public class ProductsController : Controller
    {
        ...
        [Obsolete]
        public ProductsController(Microsoft.AspNetCore.Hosting.IHostingEnvironment _env, ApplicationDbContext applicationDbContext, IConfiguration configuration)
        {
